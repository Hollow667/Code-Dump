...
public class Player {
	 ...
	 * return		wether the sum of the new hand is below of above 21
	 */
	public boolean addCard(Card aCard) {
	
		// print error if we already have the max number
		if (this.numCards == 10) {
		...
		// add new card in next slot and increment number
	...
	public int getHandSum() {
		...
		// if we have aces and our sum is >21, set some/all of
		//them to value 1 instead
	...
	/*
	 * Print the cards int the player's hand
	 * 
	 * param showFirstCard wether the first card is hidden or not
	 */
